...
public class LoginActivityfirm extends AppCompatActivity {//Starting setup for the different login pages for the different types of users for the app
    ...
    public void login(View v) {
        ...
        String url = Const.URL + "/firm-login";
